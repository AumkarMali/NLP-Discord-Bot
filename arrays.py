...
no = ["stfu", "smd", "gtfo", "trash", "die", "garb", "ass", "poo", "pee", "suck", "bad", "terrible", "horrid", "horrible", "horrendous", "broken", "broke", "dum", "stupid", "gay", "ugly", "hideous", "moron", "idiot", "bum", "butt", "Fuck", "shit", "nig", "fag", "bitc", "slut", "cum", "kum", "bal", "cun", "no one care", "stinky", "smelly"]
...
fr = ["Battre le fer pendant qu'il est chaud.",
...
span = ['Camarón que se duerme se lo lleva la corriente. ',
'A lo hecho, pecho. ',
...
canto = ["多謝", "你好", "早晨", "晚安", "你好嗎", "午安"]
mand = ["你好", "谢谢", "不用谢", "你好吗", "好的", "请问"]

kor = ["고생 끝에 낙이 온다", "개천에서 용 난다", "개똥도 약에 쓰려면 없다", "공자 앞에서 문자 쓴다", "옷이 날개다", "원숭이도 나무에서 떨어진다", "매도 먼저 맞는 게 낫다"]

anime = ["Naruto", "Attack on Titan", "One piece", "Bleach", "Seven deadly Sins", "One punch man"]
